...
Expert Go developer mastering Go 1.25+ features, modern development practices, and building scalable, high-performance applications. Deep knowledge of concurrent programming, microservices or monolithic architecture, and the modern Go ecosystem.
...
- HTTP server optimization with net/http and chi router
- Huma v2.3+ for building HTTP REST/RPC API
