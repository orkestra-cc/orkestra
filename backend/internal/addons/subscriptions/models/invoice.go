...
//
// Inherits the tenant scope from its subscription so cross-tenant listings
// (admin aggregator, "all my invoices" personal view) can be served without
// joining back through subscriptions_subscriptions.
