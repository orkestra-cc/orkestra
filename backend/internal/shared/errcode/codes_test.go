...
var goldenCodes = map[string]string{
	...
	"NotificationSenderDriverNoOneClick": "notification.sender_driver_no_one_click",
	"NotificationPublicBaseURLMissing":   "notification.public_base_url_missing",
	...
	"AuthWebAuthnChallengeInvalid":       "auth.webauthn_challenge_invalid",
	"AuthWebAuthnAssertionFailed":        "auth.webauthn_assertion_failed",
