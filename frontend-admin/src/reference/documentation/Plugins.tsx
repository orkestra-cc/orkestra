...
const Plugins = () => {
  const [plugins] = useState([
    ...
    {
      title: 'Emoji Picker',
      description: `<strong>Emoji Picker</strong> is a Slack-like customizable
      emoji picker component for React`,
      docLink: 'https://github.com/ealush/emoji-picker-react'
    },
    {
      title: 'Fuse.js',
...

    {
      ...
      description: `Modern React lightbox component. Performant, easy to use, customizable and extendable.`,
