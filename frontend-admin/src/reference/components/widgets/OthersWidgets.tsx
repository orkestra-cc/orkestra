...
import EventFooter from 'reference/app-examples/events/create-an-event/EventFooter';
import BirthdayNotice from 'reference/app-examples/social/feed/BirthdatNotice';
