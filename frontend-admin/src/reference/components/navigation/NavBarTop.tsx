...
const NavBarTop = () => {
  ...
  return (
    <>
      <PageHeader
        title="Navbar Top"
        description="Navbar Top is a different user friendly layout system in Orkestra. You can start developing with Navbar Top layout with the starter page."
        className="mb-3"
      >
        <Button
          onClick={() =>
      ...
      <Card className="mb-3">
        ...
        <Card.Body className="bg-body-tertiary">
          <p>
            Orkestra Navbar Top support all of
