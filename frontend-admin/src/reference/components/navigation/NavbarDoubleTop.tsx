  ...
  return (
    <>
      ...
      <Card className="mb-3">
        ...
        <Card.Body className="bg-body-tertiary">
          <p>
            Changing the color of Orkestra Navbar Double Top is very easy.
            Orkestra uses React-Bootstrap's default{' '}
            <code> variant='light' </code> for navabr component. You can use
            other background-color utilitie with <code>bg</code> prop to update
            the Navbar. Learn more about React-Bootstrap Navbar{' '}
            <a
