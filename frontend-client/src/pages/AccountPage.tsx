...
// quick links to profile, security, and billing details. useMe reads
// from the cache the AuthProvider populated on signIn so the page
// renders synchronously after a fresh login.
