...
Combined with the [`pkg/sdk/iface`](/sdk/shared-iface) interfaces, this is how Orkestra avoids cross-module concrete imports: every consumer programs against an interface, every producer publishes one.
