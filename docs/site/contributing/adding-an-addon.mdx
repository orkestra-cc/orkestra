...
- **Never import another addon's `services/` or `repository/` package** from `module.go`. Use `pkg/sdk/iface` interfaces and pull dependencies through `deps.Services.GetTyped[T]`. See [Service registry](/sdk/service-registry).
...
func (m *Module) Collections() []module.CollectionSpec {
    return []module.CollectionSpec{
        {
            Name: "youraddon_widgets",                  // see orkestra-mongo-collection-naming
